...
print("Load .npy")
cp = np.load('D:/Master_2019_2021/Muti_Party_Computation/CloudComputation/CP_cpu_dp.npy')
colab = np.load('D:/Master_2019_2021/Muti_Party_Computation/CloudComputation/Colab_cpu_dp.npy')
ImageP = np.load('D:/Master_2019_2021/Muti_Party_Computation/CloudComputation/DP_cpu.npy')
...
pad_back = cp[1][list(cp[1]).index('08:13'):len(cp[1])]
...
plt.ylim(0,100)
plt.xticks(rotation=45)
plt.legend(labels=['Computer (Deep Learning)'], loc='upper right',fontsize = 'x-large')
