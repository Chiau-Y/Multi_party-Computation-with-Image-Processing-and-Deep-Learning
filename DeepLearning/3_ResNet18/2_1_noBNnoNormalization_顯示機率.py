...
if __name__ == '__main__': 
    ...
    model = tf.keras.models.load_model("./model/ResNet18_b10_e5_lr0005_08_noBN")#, custom_objects={'softplus':tf.keras.activations.softplus})
    ...
    # --------------------------------- Predict --------------------------------- #
    probabilities = model2.predict(x_test[testing_num].reshape(1,32,32,3))
    ...
    #     plt.xticks([])
    #     plt.yticks([])
    #     plt.imshow(cv2.convertScaleAbs(party[i]))
