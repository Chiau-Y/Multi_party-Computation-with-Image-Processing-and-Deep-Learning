...
def Reconstruction(share):
    ...
    c_p = np.array([0.6667, -0.1667]) # 0.6667, -0.1667 # 0.75, -0.3, 0.05 # 0.8, -0.4, 0.1143, -0.0143
    c_n = np.array([-0.1667, 0.6667]) # -0.1667, 0.6667 # 0.05, -0.3, 0.75 # -0.0143, 0.1143, -0.4, 0.8
...
if __name__ == '__main__': 
    ...
    model = tf.keras.models.load_model("./model/ResNet18_b10_e5_lr0005_08_noBN")
    ...
    for testing_num in range (0,num): 
        ...
        # print("------------------- Predict -------------------")
        probabilities_ = model.predict(x_test_normalize[testing_num].reshape(1,32,32,3))
