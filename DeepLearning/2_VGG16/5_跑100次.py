...
def Reconstruction(share):
    ...
    c_p = np.array([6, -15, 20, -15, 6, -1]) # 4,-6, 4, -1  # 3, -3, 1 # 5, -10, 10, -5, 1 # 6, -15, 20, -15, 6, -1 
    c_n = np.array([1, 6, -15, 20, -15, 6]) # -1, 4, -6, 4  # 1, -3, 3 # 1, -5, 10, -10, 5 # 1, 6, -15, 20, -15, 6
...
if __name__ == '__main__': 
    ...
    model = tf.keras.models.load_model("./model/VGG16_b40_e8_dense1024.h5")
