...
if __name__ == '__main__':
    ...
    x_test_normalize_ = x_test_normalize      
    ...
    # print("---------------- Distributon ----------------")
    party = Distribution(x_test_reshaped[testing_num].reshape(32,32))  
             
    # --------------------------------- Predict --------------------------------- #
    probabilities = model2.predict(x_test_normalize[testing_num].reshape(1,32,32,1))
    ...
    print("")
    print("It is {}.".format(np.argmax(y_test[testing_num])))
