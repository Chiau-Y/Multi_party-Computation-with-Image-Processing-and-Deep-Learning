...
# Reference : https://gist.github.com/e96031413/f8817d35cb538e949331e5109a49ead1
...
def search_file(service, download_drive_service_name,time_now_utc=None):
    """
...
def main(is_download_file_function=False, download_drive_service_name=None, download_file_path=None,
         drive_service_folder_name=None,cred_download_file=None,token_download_file=None,time_now=False):
    """
    ...
    if is_download_file_function is True:
        ...
        # 判斷說 如果沒有資料夾時，會跑這塊搜尋找個雲端上的檔案 PS:這塊部分我沒有針對Google Drive上所建立的檔案去做下載動作，如果指定Google Drive的檔案會有問題
        ...
        drive_service_file_id = search_file(service=service, download_drive_service_name=download_drive_service_name,time_now_utc=time_now)  # 取得要下載
        return drive_service_file_id
